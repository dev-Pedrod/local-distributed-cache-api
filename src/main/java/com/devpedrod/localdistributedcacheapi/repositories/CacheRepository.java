package com.devpedrod.localdistributedcacheapi.repositories;
...
public class CacheRepository {
    ...
    public Mono<Boolean> save(String key, String value){
        return reactiveRedisTemplate
                ...
                .onErrorResume(throwable -> {
                    log.error("Error ao tentar salvar dados no Redis: {}", key, throwable);
    ...
    public Mono<Boolean> existsForKey(String key) {
        return reactiveRedisTemplate
                .hasKey(key) // Verifica se a chave existe.
                .onErrorResume(throwable -> {
